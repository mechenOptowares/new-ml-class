...
# number of inception layer to freeze = freeze layer will not be trained, but the remaining will be trained = this can 
# artificially increase the number of validation samples
# freeze the first 1/3 of network, train with the remaining 2/3. 
# Having slow learning rate is the key
